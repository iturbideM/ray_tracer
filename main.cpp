...
//     auto material_ground = std::std::make_shared<lambertian>(color(0.8, 0.8, 0.0));
//     auto material_center = std::std::make_shared<lambertian>(color(0.1, 0.2, 0.5));
//     auto material_left = std::std::make_shared<dielectric>(1.50);
//     auto material_bubble = std::std::make_shared<dielectric>(1.0 / 1.5);
//     auto material_right = std::std::make_shared<metal>(color(0.8, 0.6, 0.2), 1.0);
...
//     auto material_left = std::std::make_shared<lambertian>(color(0, 0, 1));
//     auto material_right = std::std::make_shared<lambertian>(color(1, 0, 0));
...
void checkered_spheres() {
    ...
    world.add(
        std::make_shared<sphere>(point3(0, -10, 0), 10, std::make_shared<lambertian>(checker)));
    world.add(
        std::make_shared<sphere>(point3(0, 10, 0), 10, std::make_shared<lambertian>(checker)));
...
void quads() {
    ...
    // Quads
    world.add(
        std::make_shared<quad>(point3(-3, -2, 5), vec3(0, 0, -4), vec3(0, 4, 0), left_red));
    world.add(
        std::make_shared<quad>(point3(-2, -2, 0), vec3(4, 0, 0), vec3(0, 4, 0), back_green));
    world.add(
        std::make_shared<quad>(point3(3, -2, 1), vec3(0, 0, 4), vec3(0, 4, 0), right_blue));
    world.add(
        std::make_shared<quad>(point3(-2, 3, 1), vec3(4, 0, 0), vec3(0, 0, 4), upper_orange));
    world.add(
        std::make_shared<quad>(point3(-2, -3, 5), vec3(4, 0, 0), vec3(0, 0, -4), lower_teal));
...
void simple_light() {
    ...
    world.add(std::make_shared<sphere>(point3(0, 2, 0), 2,
                                       std::make_shared<lambertian>(color(0.5, 0.3, 0.1))));

    auto difflight = std::make_shared<diffuse_light>(color(4, 4, 4));
    world.add(std::make_shared<sphere>(point3(-7, 7, 0), 2, difflight));
    world.add(
        std::make_shared<quad>(point3(3, 1, -2), vec3(2, 0, 0), vec3(0, 2, 0), difflight));
...
void cornell_box() {
    ...
    world.add(
        std::make_shared<quad>(point3(555, 0, 0), vec3(0, 555, 0), vec3(0, 0, 555), green));
    world.add(std::make_shared<quad>(point3(0, 0, 0), vec3(0, 555, 0), vec3(0, 0, 555), red));
    world.add(std::make_shared<quad>(point3(343, 554, 332), vec3(-130, 0, 0), vec3(0, 0, -105),
                                     light));
    world.add(std::make_shared<quad>(point3(0, 0, 0), vec3(555, 0, 0), vec3(0, 0, 555), white));
    world.add(std::make_shared<quad>(point3(555, 555, 555), vec3(-555, 0, 0), vec3(0, 0, -555),
                                     white));
    world.add(
        std::make_shared<quad>(point3(0, 0, 555), vec3(555, 0, 0), vec3(0, 555, 0), white));
...
void cornell_smoke() {
    ...
    world.add(std::make_shared<quad>(point3(0, 0, 0), vec3(0, 555, 0), vec3(0, 0, 555), red));
    world.add(
        std::make_shared<quad>(point3(113, 554, 127), vec3(330, 0, 0), vec3(0, 0, 305), light));
    world.add(
        std::make_shared<quad>(point3(0, 555, 0), vec3(555, 0, 0), vec3(0, 0, 555), white));
    world.add(std::make_shared<quad>(point3(0, 0, 0), vec3(555, 0, 0), vec3(0, 0, 555), white));
    world.add(
        std::make_shared<quad>(point3(0, 0, 555), vec3(555, 0, 0), vec3(0, 555, 0), white));
...
void final_scene(int image_width, int samples_per_pixel, int max_depth) {
    ...
    auto light = std::make_shared<diffuse_light>(color(7, 7, 7));
    world.add(
        std::make_shared<quad>(point3(123, 554, 147), vec3(300, 0, 0), vec3(0, 0, 265), light));
    ...
    boundary =
        std::make_shared<sphere>(point3(0, 0, 0), 5000, std::make_shared<dielectric>(1.5));
    ...
    // TODO: Make this a beautiful rotated cube
    std::shared_ptr<hittable> box1 = box(point3(0, 0, 0), point3(70, 70, 70),
                                         std::make_shared<lambertian>(color(0.73, 0.73, 0.73)));
    box1 = std::make_shared<rotate_y>(box1, 25);
    box1 = std::make_shared<rotate_x>(box1, 25);
    box1 = std::make_shared<translate>(box1, vec3(250, 240, 80));
    world.add(box1);
